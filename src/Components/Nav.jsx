...
function Nav({open , toggle}) {
    ...
    return (
        <nav onClick={()=> toggle()} className={`font-Poppins container flex items-start py-4 mt-4 px-7 sm:mt-12 sticky top-0 z-20 ${scrollNav && 'scroll_nav'}`}>
            ...
            <div className="flex sm:hidden flex-1 justify-end flex-shrink-0">
                {open ? <i class=" text-2xl fas fa-times"></i> : <i className="text-2xl fas fa-bars"></i>}
